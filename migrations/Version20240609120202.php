 ...
 */
final class Version20240609120202 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE actividad (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, fecha_hora_inicio DATETIME NOT NULL, fecha_hora_fin DATETIME DEFAULT NULL, compuesta TINYINT(1) NOT NULL, evento VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
